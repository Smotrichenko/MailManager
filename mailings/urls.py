...
from mailings.views_stats import StatsView
...
urlpatterns = [
    ...
    path("mailings/<int:pl>/toggle-enabled", ToggleMailingEnabledView.as_view(), name="mailing_toggle_enabled"),
    path("stats/", StatsView.as_view(), name="stats"),

    path("", cache_page(60)(HomeView.as_view()), name="home"),
    path("mailings/", cache_page(30)(MailingsListView.as_view()), name="mailing_list"),
]
