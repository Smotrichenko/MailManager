...
from mailings.views import (
    HomeView, MailingsCreateView, MailingsDeleteView, MailingsDetailView, MailingsListView, MailingsUpdateView,
    MessageCreateView, MessageDeleteView, MessageListView, MessageUpdateView,
    RecipientCreateView, RecipientDeleteView, RecipientListView, RecipientUpdateView,
    send_mailing_view,
)
...
urlpatterns = [
    ...
    path("mailings/<int:pk>/edit/", MailingsUpdateView.as_view(), name="mailing_update"),
